...
if (isset($_GET["generate_bill"])) {
  ...
  $content .= '
      <br/>
      <h2 align ="center"> SHIPPUDEN Hospitals</h2></br>
...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> SHIPPUDEN Hospital </a>
              ...
              <tbody>
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1)) { ?> <a href="admin-panel.php?ID=<?php echo $row['ID'] ?>&cancel=update"
